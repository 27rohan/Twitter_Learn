...
def call_me(usern):
	...
	# Putting in the format required for visualization
	tags_rcmd.set_index('user', inplace=True)
	tg_vl = list(tags_rcmd.ix[username,:])
...
#url = 'http://54.201.45.185/brood/frontend.html'
...
#sudo cp ./frontend.html /var/www/html/brood
#sudo cp ./bro.csv /var/www/html/brood
#sudo cp ./tag.csv /var/www/html/brood
